...
module.exports={
  ...
  "gradients": {
    ...
    "right-top-ear-gradient": {
      "type": "linear",
      "x1": "57.31666666666667%",
      "y1": "15.06958762886598%",
      "x2": "95.05695443645084%",
    ...
    "left-ear-gradient": {
      "type": "linear",
      "x1": "28.42901678657074%",
      "y1": "42.91662371134021%",
      "x2": "-6.43326139088729%",
      "y2": "11.477268041237112%",
      "gradientUnits": "userSpaceOnUse",
      "stops": [
        {
          "stop-color": "#541758"
    ...
    "right-ear-gradient": {
      "type": "linear",
      "x1": "64.30443645083933%",
      "y1": "43.14716494845361%",
      "x2": "104.75275779376499%",
      "y2": "18.048840206185567%",
      "gradientUnits": "userSpaceOnUse",
      "stops": [
        {
          "stop-color": "#541758"
...
},{"..":4,"../util":14,"./flask-fox.json":1,"copy-to-clipboard":5}],3:[function(require,module,exports){
module.exports={
  "positions": [
    [111.024597, 52.604599, 46.225899],
    [114.025002, 87.673302, 58.9818],
